...
const About = () => {
    ...
    return (
        <Route
            title="About"
            description={`A marketplace to find and publish open data sets on ZDeFi, powered by the Ocean ${market.network} Network.`}
        >
            <Content>
                <p>
                    ZDeFi allows you to access thousands of datasets for free
                    ...
                    crypto experience. If you are looking for fintech quality data, you
                    can easily use the ZDeFi to search for and find publicly
                    available datasets that are free of charge. If you are
                    interested in sharing your data, you can use the ZeFi to
